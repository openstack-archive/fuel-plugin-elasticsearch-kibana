...
performed automatically by the plugin and therefore there is no need to do it any manualy operation
...
The output below shows that the replication factor of the indeces before the scale up are not
