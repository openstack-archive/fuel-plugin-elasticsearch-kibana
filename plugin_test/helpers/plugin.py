...
from openstack_utils import assign_net_provider
...
class TestPlugin(TestBasic):
    ...
    def prepare_plugin(self, slaves=None, options={}):
        ...
        assign_net_provider(self, **options)
    ...
    def check_elasticsearch_plugin(self):
