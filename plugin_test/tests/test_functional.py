...
class IntegrationTests(TestBasic):
    ...
    def contrail_plugin_add_delete_controller_node(self):
        ...
        Scenario:
            ...
            10. Run OSTF tests. All steps must be completed successfully,
                without any errors.
        """
        plugin.prepare_plugin(self, slaves=9)
        ...
        openstack.update_deploy_check(self, conf_ctrl, delete=True)
        openstack.update_deploy_check(self, conf_ctrl)
    ...
    def elasticsearch_kibana_plugin_add_delete_compute_node(self):
        ...
        openstack.update_deploy_check(self, conf_compute, delete=True)
